...
public final class DataTransferGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.examples.route_guide.LearningData.Data,
      io.grpc.examples.route_guide.LearningData.ModelResponse> getSendDataToModelMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "send_data_to_model",
      requestType = io.grpc.examples.route_guide.LearningData.Data.class,
      responseType = io.grpc.examples.route_guide.LearningData.ModelResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<io.grpc.examples.route_guide.LearningData.Data,
      io.grpc.examples.route_guide.LearningData.ModelResponse> getSendDataToModelMethod() {
    io.grpc.MethodDescriptor<io.grpc.examples.route_guide.LearningData.Data, io.grpc.examples.route_guide.LearningData.ModelResponse> getSendDataToModelMethod;
      ...
      synchronized (DataTransferGrpc.class) {
        if ((getSendDataToModelMethod = DataTransferGrpc.getSendDataToModelMethod) == null) {
          DataTransferGrpc.getSendDataToModelMethod = getSendDataToModelMethod = 
              io.grpc.MethodDescriptor.<io.grpc.examples.route_guide.LearningData.Data, io.grpc.examples.route_guide.LearningData.ModelResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "DataTransfer", "send_data_to_model"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.route_guide.LearningData.Data.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.route_guide.LearningData.ModelResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new DataTransferMethodDescriptorSupplier("send_data_to_model"))
                  .build();
          }
        }
     }
  ...
  public static abstract class DataTransferImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<io.grpc.examples.route_guide.LearningData.Data> sendDataToModel(
        io.grpc.stub.StreamObserver<io.grpc.examples.route_guide.LearningData.ModelResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getSendDataToModelMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                io.grpc.examples.route_guide.LearningData.Data,
                io.grpc.examples.route_guide.LearningData.ModelResponse>(
  ...
  public static final class DataTransferStub extends io.grpc.stub.AbstractStub<DataTransferStub> {
    ...
    public io.grpc.stub.StreamObserver<io.grpc.examples.route_guide.LearningData.Data> sendDataToModel(
      ...
      return asyncBidiStreamingCall(
          getChannel().newCall(getSendDataToModelMethod(), getCallOptions()), responseObserver);
    }
  }
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_SEND_DATA_TO_MODEL:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.sendDataToModel(
              (io.grpc.stub.StreamObserver<io.grpc.examples.route_guide.LearningData.ModelResponse>) responseObserver);
        default:
          throw new AssertionError();
      }
  ...
  private static abstract class DataTransferBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.grpc.examples.route_guide.LearningData.getDescriptor();
    }
